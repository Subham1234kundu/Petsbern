...
export default function Home() {
  const homeFAQs = [
    {
      question: "Do you offer international pet delivery?",
      answer: "Yes, we provide both domestic and international pet relocation services with IATA-approved crates and full documentation support."
    },
    {
      question: "Are all pets vet-checked and vaccinated?",
      answer: "Absolutely. Every pet at Pets Barn undergoes a rigorous health check by certified veterinarians and comes with up-to-date vaccination records."
    },
    {
      question: "How do I choose the right breed for my lifestyle?",
      answer: "We offer expert breed consultation services where we assess your living situation, activity level, and preferences to match you with the perfect companion."
    },
    {
      question: "Do you provide post-adoption support?",
      answer: "Yes, we believe in lifetime care. We provide guidance on nutrition, training, and health even after your pet has settled into their new home."
    }
  ];
  ...
  return (
    <HomeAnimations>
      <div className="flex flex-col min-h-screen bg-white font-sans pb-12">
          ...
          <section data-animate="why-petsbarn" className="mt-16 bg-[#1C4B42] rounded-[32px] overflow-hidden relative flex flex-col items-center pt-16">
            ...
            <div className="w-full px-4 sm:px-8 lg:px-12 relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-12 sm:mb-16">
                {/* Box 1 */}
                <div data-animate="why-card" className="rounded-2xl p-5 sm:p-6 h-auto sm:h-[240px] lg:h-[267px] relative flex flex-col bg-white/10 overflow-hidden border border-white/5">
            ...
            {/* Bottom Image */}
            <div data-animate="why-image" className="w-full mt-auto">
              <img
        ...
        <section data-animate="favorites-section" className="bg-white rounded-none relative flex flex-col items-center w-full pb-24">
          ...
          <div className="w-full max-w-[1200px] px-4 sm:px-8 lg:px-12 relative z-10 pt-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
              ...
              <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
                {/* Pug Card */}
                <div data-animate="fav-small" className="bg-white/80 backdrop-blur-sm rounded-[24px] p-6 relative flex flex-col justify-between group cursor-pointer h-[200px] lg:h-[250px] border border-white/40 shadow-sm hover:shadow-md transition-all">
        ...
        <section data-animate="steps-section" className="pt-8 pb-18 relative overflow-hidden flex flex-col items-center w-full ">
          ...
          <div className="w-full max-w-[1240px] px-4 relative z-10">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-end justify-center gap-5 ">
              {/* Step 01 */}
              <div data-animate="step-card" className="w-full max-w-[390px] h-[500px] lg:h-[580px] rounded-[40px] relative overflow-hidden p-6 lg:p-10 flex flex-col bg-gradient-to-b from-[#53A4C0] via-[#53A4C0] to-white/60">
              ...
              {/* Step 02 */}
              <div data-animate="step-card" className="w-full max-w-[390px] h-[500px] lg:h-[640px] rounded-[40px] relative overflow-hidden p-6 lg:p-10 flex flex-col bg-gradient-to-b from-[#FFA2B6] via-[#FFA2B6] to-white/60">
                <div className="w-32 h-32 flex items-center justify-center self-center mb-10 mt-2">
                  <img
              ...
              {/* Step 03 */}
              <div data-animate="step-card" className="w-full max-w-[390px] h-[500px] lg:h-[700px] rounded-[40px] relative overflow-hidden p-6 lg:p-10 flex flex-col bg-gradient-to-b from-[#066168] via-[#066168] to-white/60">
                <div className="w-32 h-32 flex items-center justify-center self-center mb-10 mt-2">
                  <img
        ...
        <section data-animate="testimonials-section" className="bg-[#F8F8F8] py-12 relative overflow-hidden flex flex-col items-center w-full">
          ...
          <div className="w-full max-w-[1240px] px-4 relative z-10">
            ...
            <div className="flex flex-col lg:flex-row gap-10 items-stretch mb-15">
              {/* Video Thumbnail (40%) */}
              <div data-animate="test-video" className="lg:w-[40%] relative group cursor-pointer overflow-hidden rounded-3xl h-[250px] sm:h-[350px] lg:h-[388px]">
                <img
              ...
              {/* Quote Card (60%) */}
              <div data-animate="test-quote" className="lg:w-[60%] bg-white rounded-3xl p-6 lg:p-12 relative flex flex-col justify-between border border-[#EFEFEF] h-auto min-h-[300px] lg:min-h-0 lg:h-[388px] shadow-sm">
            ...
            {/* Happy Family Grid */}
            <div data-animate="family-grid" className="flex flex-col relative items-center z-10">
        ...
        <section data-animate="tips-section" className="py-24 bg-white flex flex-col items-center w-full">
          <div className="w-full max-w-[1240px] px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
              {/* Tip Card 1 */}
              <div data-animate="tip-card" className="bg-[#F6F6F6] rounded-[24px] sm:rounded-[40px] p-4 sm:p-6 h-auto sm:h-[300px] lg:h-[355px] flex flex-col sm:flex-row items-center gap-4 sm:gap-8 group cursor-pointer transition-all hover:shadow-lg relative overflow-hidden" suppressHydrationWarning>
                ...
                <div className="w-full sm:w-[55%] flex flex-col justify-between sm:h-full py-2 sm:py-4 relative z-10">
                  <div className="pt-1 sm:pt-2" suppressHydrationWarning>
                  ...
                  <div className="self-end mr-2 mb-2" suppressHydrationWarning>
                    <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-sm transition-all text-black group-hover:bg-black group-hover:text-white" suppressHydrationWarning>
                      <svg
                        width="20"
                        height="20"
                        viewBox="0 0 24 24"
              ...
              {/* Tip Card 2 */}
              <div className="bg-[#F6F6F6] rounded-[24px] sm:rounded-[40px] p-4 sm:p-6 h-auto sm:h-[300px] lg:h-[355px] flex flex-col sm:flex-row items-center gap-4 sm:gap-8 group cursor-pointer transition-all hover:shadow-lg relative overflow-hidden" suppressHydrationWarning>
                {/* White file-tab cutout effect using precise SVG S-curve */}
                <div className="absolute top-0 left-0 w-full h-[25%] z-0 pointer-events-none">
                  <svg
                    className="w-full h-full"
        ...
        <section data-animate="consult-section" className=" bg-white flex flex-col items-center w-full">
          <div className="w-full max-w-[1240px] px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div data-animate="consult-image" className="relative rounded-[24px] sm:rounded-[32px] overflow-hidden min-h-[350px] sm:min-h-[450px] lg:min-h-0">
                <img
                  src="/images/goldenfav.png"
