  ...
  return (
    <ServiceAnimations>
      <div className="flex flex-col min-h-screen bg-white font-sans">
        ...
        {/* Main Content Area */}
        <main className="w-full max-w-[1440px] 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 py-12 lg:py-16 2xl:py-24 flex-grow">

          {/* Why Choose Section */}
          <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12 lg:gap-16 2xl:gap-24">

            {/* Left Column */}
            <div data-animate="service-text" className="flex-1 max-w-[580px] 2xl:max-w-[700px] text-center lg:text-left">
              <h2 className="text-[28px] md:text-[32px] lg:text-[36px] 2xl:text-[44px] font-normal text-[#0A0A0A] leading-tight" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>
                Why Choose{" "}
                <span style={{ color: "#FFC501" }}>Pets Barn Training</span>?
              </h2>

              <p className="mt-4 text-[16px] lg:text-[18px] 2xl:text-[20px] text-[#4A5565] leading-relaxed">
              ...
              <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-x-8 lg:gap-x-10 2xl:gap-x-16 gap-y-10 2xl:gap-y-14 items-start text-left">
                ...
                <div data-animate="feature-item" className="flex flex-col gap-3 2xl:gap-4">
                  <div className="w-[44px] h-[44px] 2xl:w-[52px] 2xl:h-[52px] rounded-full flex items-center justify-center" style={{ backgroundColor: "#FFC501" }}>
                    <svg width="22" height="22" className="2xl:w-6 2xl:h-6" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <circle cx="12" cy="8" r="4" /><path d="M6 20v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2" />
                    </svg>
                  </div>
                  <h3 className="text-[18px] lg:text-[20px] 2xl:text-[24px] font-normal text-[#0A0A0A]" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>Certified Trainers</h3>
                  <p className="text-[13px] lg:text-[14px] 2xl:text-[16px] text-[#11111199] leading-relaxed">Experienced professionals dedicated to your pet's success and well-being.</p>
                </div>
                ...
                <div data-animate="feature-item" className="flex flex-col gap-3 2xl:gap-4">
                  ...
                  <h3 className="text-[18px] lg:text-[20px] 2xl:text-[24px] font-normal text-[#0A0A0A]" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>Positive Methods</h3>
                  <p className="text-[13px] lg:text-[14px] 2xl:text-[16px] text-[#11111199] leading-relaxed">Reward-based training that builds trust, confidence, and lasting good behavior.</p>
                </div>
                ...
                <div data-animate="feature-item" className="flex flex-col gap-3 2xl:gap-4">
                  ...
                  <h3 className="text-[18px] lg:text-[20px] 2xl:text-[24px] font-normal text-[#0A0A0A]" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>Customized Programs</h3>
                  <p className="text-[13px] lg:text-[14px] 2xl:text-[16px] text-[#11111199] leading-relaxed">Training plans tailored to your pet's age, breed, and personality.</p>
                </div>
                ...
                <div data-animate="feature-item" className="flex flex-col gap-3 2xl:gap-4">
                  ...
                  <h3 className="text-[18px] lg:text-[20px] 2xl:text-[24px] font-normal text-[#0A0A0A]" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>Progress Tracking</h3>
                  <p className="text-[13px] lg:text-[14px] 2xl:text-[16px] text-[#11111199] leading-relaxed">Regular updates and insights to monitor your pet's improvement.</p>
                </div>
        ...
        <section className="w-full py-16 md:py-20 2xl:py-28" style={{ backgroundColor: "#F7F7F7" }}>
          <div className="max-w-[1440px] 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12">

            {/* Section Heading */}
            <h2 data-animate="service-title" className="text-center mb-12 md:mb-16 text-[28px] md:text-[32px] lg:text-[36px] 2xl:text-[46px] font-normal text-[#0A0A0A]" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>
              Training Programs <span style={{ color: "#FFC501" }}>We Offer</span>
            </h2>

            {/* Cards Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-6 2xl:gap-10 justify-items-center">
              ...
              {[
                ...
                <div
                  ...
                  className="bg-white flex flex-col p-6 2xl:p-8 rounded-2xl border border-gray-200 shadow-sm w-full max-w-[320px] 2xl:max-w-[370px] min-h-[420px] 2xl:min-h-[500px] h-full"
                >
                  {/* Title + Description */}
                  <div className="mb-6 h-auto lg:h-[110px] 2xl:h-[130px]">
                    <h3 className="text-[17px] lg:text-[18px] 2xl:text-[22px] font-bold text-[#4A5565] leading-snug mb-3" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>
                      {card.title}
                    </h3>
                    <p className="text-[14px] 2xl:text-[16px] text-[#6A7282] leading-relaxed">
                      {card.desc}
                    </p>
                  </div>
                  ...
                  {/* Call Us Button */}
                  <button
                    className="flex items-center justify-center bg-black text-white rounded-full w-full h-[48px] 2xl:h-[54px] text-[15px] 2xl:text-[16px] font-medium hover:bg-gray-900 transition-all mb-8 shadow-md active:scale-95"
                  >
                    Call Us
                  </button>
                  ...
                  <div className="flex flex-col gap-4 mt-auto">
                    {card.features.map((f) => (
                      <div key={f} className="flex items-start gap-3">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#364153" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 mt-0.5 animate-pulse">
                          <polyline points="20 6 9 17 4 12" />
                        </svg>
                        <span className="text-[14px] 2xl:text-[16px] text-[#364153] leading-tight">{f}</span>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <section className="bg-white w-full py-16 md:py-20 2xl:py-28">
          <div className="max-w-[1440px] 2xl:max-w-[1600px] mx-auto w-full px-4 sm:px-6 lg:px-12">
            ...
            <div className="flex flex-col lg:flex-row items-stretch justify-center gap-8 lg:gap-6 2xl:gap-10 relative">
              ...
              <div data-animate="service-card" className="w-full max-w-[380px] 2xl:max-w-[430px] border border-[#C8C8C8] rounded-2xl p-6 lg:p-8 2xl:p-10 pt-10 2xl:pt-12 flex flex-col items-center text-center mx-auto lg:mx-0 transition-all hover:border-[#FFC501] group shadow-sm">
                ...
                <p className="text-[#4A5565] text-[14px] 2xl:text-[16px] leading-relaxed">
              ...
              <div data-animate="service-card" className="w-full max-w-[380px] 2xl:max-w-[430px] border border-[#C8C8C8] rounded-2xl p-6 lg:p-8 2xl:p-10 pt-10 2xl:pt-12 flex flex-col items-center text-center mx-auto lg:mx-0 transition-all hover:border-[#FFC501] group shadow-sm">
                ...
                <h3 className="text-black text-[18px] lg:text-[20px] 2xl:text-[24px] font-bold mb-4">Customized Training Plan</h3>
                <p className="text-[#4A5565] text-[14px] 2xl:text-[16px] leading-relaxed">
              ...
              <div data-animate="service-card" className="w-full max-w-[380px] 2xl:max-w-[430px] border border-[#C8C8C8] rounded-2xl p-6 lg:p-8 2xl:p-10 pt-10 2xl:pt-12 flex flex-col items-center text-center mx-auto lg:mx-0 transition-all hover:border-[#FFC501] group shadow-sm">
                ...
                <h3 className="text-black text-[18px] lg:text-[20px] 2xl:text-[24px] font-bold mb-4">Progress & Results</h3>
                <p className="text-[#4A5565] text-[14px] 2xl:text-[16px] leading-relaxed">
        ...
        <section className="py-16 md:py-20 2xl:py-28 bg-white flex flex-col items-center w-full">
          <div className="w-full max-w-[1240px] 2xl:max-w-[1536px] px-4">
            <h2 className="text-black text-center mb-4 font-normal text-[28px] md:text-[32px] lg:text-[36px] 2xl:text-[46px]" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 2xl:gap-10 lg:mb-20 2xl:mb-28">
              {/* Tip Card 1 */}
              <div className="bg-[#F6F6F6] rounded-[32px] lg:rounded-[40px] 2xl:rounded-[48px] p-6 2xl:p-8 h-auto lg:h-[355px] 2xl:h-[390px] flex flex-col md:flex-row items-center gap-6 lg:gap-8 2xl:gap-10 group cursor-pointer transition-all hover:shadow-lg relative overflow-hidden">
                ...
                <div className="w-full md:w-[45%] 2xl:w-[40%] h-[200px] md:h-full overflow-hidden rounded-[24px] lg:rounded-[28px] 2xl:rounded-[32px] relative z-10 shadow-sm">
                ...
                <div className="w-full md:w-[55%] 2xl:w-[60%] flex flex-col justify-between h-auto md:h-full py-4 2xl:py-6 relative z-10">
                  <div className="pt-2">
                    <span className="text-[10px] lg:text-[11px] 2xl:text-[12px] text-[#FFC501] font-bold uppercase tracking-widest mb-6 lg:mb-10 2xl:mb-12 block ml-0 md:ml-2">PET TRAINING</span>
                    <h3 className="text-[18px] lg:text-[20px] 2xl:text-[24px] text-black font-normal leading-[1.4] pr-4 ml-0 md:ml-2">
              ...
              <div className="bg-[#F6F6F6] rounded-[32px] lg:rounded-[40px] 2xl:rounded-[48px] p-6 2xl:p-8 h-auto lg:h-[355px] 2xl:h-[390px] flex flex-col md:flex-row items-center gap-6 lg:gap-8 2xl:gap-10 group cursor-pointer transition-all hover:shadow-lg relative overflow-hidden">
                ...
                <div className="w-full md:w-[55%] 2xl:w-[60%] flex flex-col justify-between h-auto md:h-full py-4 2xl:py-6 relative z-10">
                  <div className="pt-2">
                    <span className="text-[10px] lg:text-[11px] 2xl:text-[12px] text-[#FFC501] font-bold uppercase tracking-widest mb-6 lg:mb-10 2xl:mb-12 block ml-0 md:ml-2">PET TRAVEL</span>
                    <h3 className="text-[18px] lg:text-[20px] 2xl:text-[24px] text-black font-normal leading-[1.4] pr-4 ml-0 md:ml-2">
        ...
        <section className="py-16 md:py-24 2xl:py-32 bg-[#F7F7F7] flex flex-col items-center justify-center w-full">
          <div className="w-full max-w-[1440px] 2xl:max-w-[1600px] px-4 sm:px-6 lg:px-12">
            <h2 data-animate="service-title" className="text-black text-center mb-12 md:mb-16 text-[26px] md:text-[32px] lg:text-[36px] 2xl:text-[46px] font-normal" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>
              Why <span className="text-[#FFC501]">Training</span> Pets?
            </h2>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-6 2xl:gap-8 justify-items-center">
              {/* Box 1 */}
              <div className="w-full max-w-[320px] 2xl:max-w-[370px] bg-white rounded-[32px] p-8 2xl:p-10 flex flex-col shadow-sm border border-[#EFEFEF] group hover:border-[#FFC501] transition-all h-full">
                <div className="w-10 h-10 2xl:w-12 2xl:h-12 rounded-full bg-[#FFC501] flex items-center justify-center mb-6 2xl:mb-8 shadow-sm">
                ...
                <h3 className="mb-4 text-[18px] lg:text-[20px] 2xl:text-[24px] font-bold text-black leading-tight" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>Better Behavior at Home</h3>
                <p className="mb-6 text-[14px] md:text-[15px] 2xl:text-[16px] text-[#6E6E6E] leading-relaxed">
                  Training helps pets understand what’s right and wrong in their environment.
                </p>
                <div className="mt-auto">
                  <h4 className="font-bold mb-2 text-[14px] md:text-[15px] 2xl:text-[16px] text-black">Reduces issues like:</h4>
                  <ul className="space-y-1">
                    <li className="text-[14px] 2xl:text-[15px] text-[#6E6E6E] flex items-center gap-2">
              ...
              <div className="w-full max-w-[320px] 2xl:max-w-[370px] bg-white rounded-[32px] p-8 2xl:p-10 flex flex-col shadow-sm border border-[#EFEFEF] group hover:border-[#FFC501] transition-all h-full">
                ...
                <h3 className="mb-4 text-[18px] lg:text-[20px] 2xl:text-[24px] font-bold text-black leading-tight" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>Stronger Bond With Your Pet</h3>
                <p className="mb-6 text-[14px] md:text-[15px] 2xl:text-[16px] text-[#6E6E6E] leading-relaxed">
                  Training builds trust and effective communication between you and your pet.
                </p>
                <div className="mt-auto">
                  <h4 className="font-bold mb-2 text-[14px] md:text-[15px] 2xl:text-[16px] text-black">Improves:</h4>
                  <ul className="space-y-1">
                    <li className="text-[14px] 2xl:text-[15px] text-[#6E6E6E] flex items-center gap-2">
              ...
              <div className="w-full max-w-[320px] 2xl:max-w-[370px] bg-white rounded-[32px] p-8 2xl:p-10 flex flex-col shadow-sm border border-[#EFEFEF] group hover:border-[#FFC501] transition-all h-full">
                ...
                <h3 className="mb-4 text-[18px] lg:text-[20px] 2xl:text-[24px] font-bold text-black leading-tight" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>Safety for Pets and People</h3>
                <p className="mb-6 text-[14px] md:text-[15px] 2xl:text-[16px] text-[#6E6E6E] leading-relaxed">
                  Proper training ensures your pet is safe in public and at home.
                </p>
                <div className="mt-auto">
                  <h4 className="font-bold mb-2 text-[14px] md:text-[15px] 2xl:text-[16px] text-black">Prevents:</h4>
                  <ul className="space-y-1">
                    <li className="text-[14px] 2xl:text-[15px] text-[#6E6E6E] flex items-center gap-2">
              ...
              <div className="w-full max-w-[320px] 2xl:max-w-[370px] bg-white rounded-[32px] p-8 2xl:p-10 flex flex-col shadow-sm border border-[#EFEFEF] group hover:border-[#FFC501] transition-all h-full">
                ...
                <h3 className="mb-4 text-[18px] lg:text-[20px] 2xl:text-[24px] font-bold text-black leading-tight" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>Confident Pet</h3>
                <p className="mb-6 text-[14px] md:text-[15px] 2xl:text-[16px] text-[#6E6E6E] leading-relaxed">
                  Training helps pets feel secure and improves their social skills.
                </p>
                <div className="mt-auto">
                  <h4 className="font-bold mb-2 text-[14px] md:text-[15px] 2xl:text-[16px] text-black">Reduces:</h4>
                  <ul className="space-y-1">
                    <li className="text-[14px] 2xl:text-[15px] text-[#6E6E6E] flex items-center gap-2">
        ...
        <section className="bg-white py-16 lg:py-24 2xl:py-32 flex flex-col items-center w-full relative overflow-hidden">
          <div className="w-full max-w-[1440px] 2xl:max-w-[1600px] px-4 relative">
            <div className="relative w-full h-[300px] md:h-[447px] 2xl:h-[550px] overflow-hidden flex flex-col items-center rounded-2xl lg:rounded-none">
              <img
              ...
              <div className="absolute bottom-4 lg:bottom-10 left-1/2 -translate-x-1/2 z-20 w-full text-center px-4">
                <h3 className="text-[26px] md:text-[36px] lg:text-[42px] 2xl:text-[52px] font-normal tracking-tight leading-tight" style={{ fontFamily: "var(--font-public-sans), 'Public Sans', sans-serif" }}>
        ...
        {/* Final CTA Section */}
        <section className="w-full flex flex-col lg:flex-row overflow-hidden bg-[#F8FBFF] py-16 md:py-20 lg:py-0 lg:min-h-[591px] 2xl:min-h-[700px]">
          {/* Left Column */}
          <div className="w-full lg:w-[40%] 2xl:w-[45%] flex flex-col justify-center px-6 sm:px-10 md:px-12 lg:px-20 2xl:px-28 text-center lg:text-left items-center lg:items-start mb-12 lg:mb-0">
            <h2 className="text-black mb-8 lg:mb-10 leading-tight text-[26px] md:text-[34px] lg:text-[42px] 2xl:text-[50px] font-normal max-w-[800px] 2xl:max-w-[900px]" style={{ fontFamily: "var(--font-public-sans), sans-serif" }}>
            ...
            <button className="bg-black text-white px-10 h-[56px] lg:h-[60px] 2xl:h-[70px] rounded-full hover:bg-gray-900 transition-all shadow-lg text-[16px] lg:text-[18px] 2xl:text-[20px] font-medium active:scale-95">
              Consult For Training
            </button>
          </div>

          {/* Right Column */}
          <div className="w-full lg:w-[60%] 2xl:w-[55%] h-[300px] md:h-[450px] lg:h-full relative overflow-hidden">
            <img
