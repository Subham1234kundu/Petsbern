...
import { DOG_CHARACTERISTICS, matchesCharacteristics } from '@/lib/breedCharacteristics';
...
export default function DogsCategoryPage() {
  ...
  const displayBreeds = groupedPets.filter(pet => {
    ...
    if (!matchesCharacteristics(pet, selectedCharacteristics, DOG_CHARACTERISTICS)) return false;
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 pt-6 pb-4">
          <div className="flex items-center justify-between gap-6">
            <div className="inline-flex p-1 bg-[#F3F4F6] rounded-full w-full sm:w-auto overflow-x-auto whitespace-nowrap">
              <Link href="/pet-categories/dogs" className="flex-1 sm:flex-initial text-center px-4 md:px-8 py-2 rounded-full bg-black text-white text-[13px] sm:text-sm font-bold shadow-sm transition-all active:scale-95">Dogs</Link>
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <CharacteristicsFilter
              characteristics={DOG_CHARACTERISTICS}
          ...
          {(selectedSize !== "All Sizes" || selectedGroups.length > 0 || selectedCharacteristics.length > 0) && (
            <div className="flex flex-wrap items-center gap-2 -mt-4">
              ...
              <button
                onClick={() => { setSelectedSize("All Sizes"); setSelectedGroups([]); setSelectedCharacteristics([]); }}
              ...
              displayBreeds.map((dog) => {
                ...
                return (
                  <BreedCardFull
                    key={dog.id}
                    name={dog.breed}
                    image={dog.main_image || '/images/labrador.png'}
                    weight={dog.weight}
